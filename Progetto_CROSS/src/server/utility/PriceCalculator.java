...
public class PriceCalculator {
    ...
    public static String formatPrice(int priceInMillis) {
        return String.format("%,.0f", priceInMillis / 1000.0);
    }

    public static String formatSize(int sizeInMillis) {
    ...
    public static JsonObject calculateDayOHLC(List<JsonObject> dayTrades, String date) {
        ...
        dayTrades.sort(Comparator.comparingLong(trade -> trade.get("timestamp").getAsLong()));
